...
PCargs.StepSize = 6e-4
PCargs.MaxNumPoints = 1000  #500
PCargs.MaxStepSize = 6e-4
...
PCargs = args(name='EQ1', type='EP-C')
PCargs.freepars = ['sig_W']
PCargs.StepSize = 10e-4
PCargs.MaxNumPoints = 10  #500
...
#plt.legend([a11,a12] , [r'$\alpha=0.05$',r'$\alpha=0$'], fontsize=20, loc= 'best')
plt.xlabel(r'$\sigma_\Omega$', fontsize=20)
plt.ylabel(r'$a_1$', fontsize=20)
plt.axis([-0.0015, 0.0015, 0, 0.2])
show()
...
#a22, = plt.plot(sig_W2, A22,'o', linewidth=4.0, color = 'red')
plt.xlabel(r'$\sigma_\Omega$', fontsize=20)
#plt.legend([a21,a22] , [r'$\alpha=0.05$',r'$\alpha=0$'], fontsize=20, loc= 'best')
plt.ylabel(r'$a_2$', fontsize=20)
plt.axis([-0.0015, 0.0015, 0, 0.1])
show()
