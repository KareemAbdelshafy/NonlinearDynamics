...
PCargs.MaxNumPoints = 1000  #500
PCargs.MaxStepSize = 10e-4
...
PyCont.display(('F1','a2'), stability=True)
show()
'''
PyCont.display(('F1','b2'), stability=True)
PyCont.display(('F1','a1'), stability=True)
PyCont.display(('F1','b1'), stability=True)
show()
plt.plot(F11, A21)
plt.plot(F11, A11)
show()
...
pars['F1'] = F1
icdict = {'a1': 0.0704/2, 'a2': -0.00005/2, 'b1':  -0.00006 , 'b2': 0.0016 }
DSargs = PyDSTool.args(name='Final1')
DSargs.pars = pars
DSargs.varspecs = {'b1': b1str, 'a1': a1str, 'b2': b2str, 'a2': a2str}
DSargs.ics = icdict
...
a1, =plt.plot(F11, A11, linewidth=2.0 , color = 'blue', label='a_1')
a2, =plt.plot(F11, A21, linewidth=2.0 , color = 'red', label='a_2')
#a1, = plt.plot(F12, A12, linewidth=2.0, color = 'blue')
#a2, = plt.plot(F12, A22, linewidth=2.0, color = 'red')
plt.xlabel(r'$F_1$', fontsize=20)
plt.legend([a1,a2] , [r'$a_1$',r'$a_2$'], fontsize=20, loc= 'best')
plt.axis([0, 0.0006, 0, 0.14])
show()
