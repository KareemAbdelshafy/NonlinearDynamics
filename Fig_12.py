...
pars = {'G1': G1, 'G2': G2, 'G3': G3, 'G4': G4, 'G6': G6, 'w1': w1, 'w2': w2, 'sig_W': 0.01, 'sig_w': 0., 'phi':-pi/2, 'F1': F1, 'F2': F2, 'mu1': mu1, 'mu2': mu2}
